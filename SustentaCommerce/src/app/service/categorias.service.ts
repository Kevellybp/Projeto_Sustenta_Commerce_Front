...
export class CategoriasService {
  ...
  getByIdCategorias(id: number): Observable<Categorias>{
    return this.http.get<Categorias>(`https://sustentacommerce.herokuapp.com/categorias/id/${idCategoria}`, this.token)
  }
  ...
  deleteCategoria(id: number){
    return this.http.delete(`https://sustentacommerce.herokuapp.com/categorias/id/${idCategoria}`, this.token)
  }
}
